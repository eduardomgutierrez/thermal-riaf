...
extern double R_high;
extern Vector precomp_r;
extern Vector precomp_density;
extern Vector precomp_v;
extern Vector precomp_vphi;
extern Vector precomp_B;
extern Vector precomp_HR;
extern Vector precomp_beta;
extern Vector precomp_Temp;
extern int precompPhiIsOmega;
...
extern const double gravRadius;					// Gravitational Radius r_g = GM/c^2 = R_S/2 [cm]
extern const double blackHoleSpin;				// Black hole spin parameter a (dimensionless)
extern const double horizonRadius;				// Event horizon radius [cm] (depends on spin)
